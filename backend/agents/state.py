...
specialized sub-agents (Advait, Vihaan, Kabir, Ishaan, Aadhya, Saanvi, Myra).
"""
...
class AgentState(TypedDict, total=False):
    ...
    conversation_id: str
    session_advait_model: str
    session_myra_model: str
    session_api_key: Optional[str]

    # ── 2. ADVAIT OUTPUTS (Intent & Plan Extraction) ──────────────────────────
    ...
    # ── 3. VIHAAN OUTPUTS (Data Scout & Column Resolver) ─────────────────────
    ...
    # ── 4. KABIR OUTPUTS (Feature Engineering) ────────────────────────────────
    ...
    # ── 5. ISHAAN OUTPUTS (Segmentation Engine) ──────────────────────────────
    ...
    # ── 6. AADHYA OUTPUTS (Explainability & SHAP) ─────────────────────────────
...
def create_initial_state(
    ...
    state: AgentState = {
        ...
        "conversation_id": cid,
        "session_advait_model": advait_model,
        "session_myra_model": myra_model,
